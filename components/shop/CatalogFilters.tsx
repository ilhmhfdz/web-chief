      ...
      <div className="flex items-center gap-3">
        <form onSubmit={handleSearchSubmit} className="relative group flex-1">
          ...
          <input
            ...
            className={`w-full h-12 pl-12 pr-12 text-[15px] font-medium bg-white border rounded-2xl transition-all duration-300 placeholder:text-surface-border outline-none ${focused
